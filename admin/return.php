...
<div class="wrapper">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="#addnew" data-toggle="modal" class="btn btn-danger btn-sm btn-flat"><i class="fa fa-plus"></i> Returns</a>
            </div>
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, member.id AS stud FROM returns LEFT JOIN member ON member.id=returns.member_id LEFT JOIN book ON book.id=returns.book_id ORDER BY return_date DESC";
                    ...
                    while($row = $query->fetch_assoc()){
                      if($row['status']){
                        ...
                        $status = '<span class="label label-default">returned</span>';
                      }
                      echo "
                        <tr>
                          <td class='hidden'></td>
  ...
  <?php include 'modal/return_modal.php'; ?>
</div>
